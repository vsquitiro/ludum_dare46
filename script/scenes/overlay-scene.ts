...
class OverlayScene extends Phaser.Scene {
    vatBarBG: Phaser.GameObjects.Rectangle;
    vatBarInner: Phaser.GameObjects.Rectangle;
    
    alertTint: Phaser.GameObjects.Rectangle;

    timeSinceLastLetter: number;
    timePerLetter: number;
    messageBox: Phaser.GameObjects.Sprite;
    messageIcon: Phaser.GameObjects.Sprite;
    message: Phaser.GameObjects.Text;
    messageBlip: Phaser.Sound.BaseSound;

    instruction: Phaser.GameObjects.Text;

    inventoryStyle: Partial<Phaser.GameObjects.TextStyle>;
    invBackground: Phaser.GameObjects.Image;
    invFoodIcon: Phaser.GameObjects.Sprite;
    invFuelIcon: Phaser.GameObjects.Sprite;
    invFertIcon: Phaser.GameObjects.Sprite;
    invHungerText: Phaser.GameObjects.Text;
    invFoodCount: Phaser.GameObjects.Text;
    invFuelCount: Phaser.GameObjects.Text;
    invFertCount: Phaser.GameObjects.Text;
    invHungerCount: Phaser.GameObjects.Text;
